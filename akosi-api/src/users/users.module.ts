...
@Module({
  controllers: [UsersController, UserHistoriesController, UserProfilesController],
  providers: [PrismaService, UsersService, UserHistoriesService, UserProfilesService],
